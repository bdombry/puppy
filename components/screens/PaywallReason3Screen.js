...
const PaywallReason3Screen = ({ navigation, route }) => {
  ...
  const handleContinue = () => {
    ...
    navigation.navigate('PaywallReason4', {
      dogData,
      userData,
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.pupyBackground }}>
      <View style={{ paddingHorizontal: spacing.lg }}>
        <BackButton onPress={() => navigation.navigate('PaywallReason2')} />
          ...
          {showDescription && (
            <Animated.View style={{ opacity: descriptionOpacity, maxWidth: 280 }}>
              <Text style={{
                ...
                L'éducation adaptée à votre chien, basée sur ses données réelles et sa personnalité.
              </Text>
            </Animated.View>
          )}
        </View>
...
PaywallReason3Screen.propTypes = {
  navigation: PropTypes.object.isRequired,
  route: PropTypes.object,
};

export default PaywallReason3Screen;
