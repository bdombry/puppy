...
const PaywallReason5Screen = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.pupyBackground }}>
      <View style={{ paddingHorizontal: spacing.lg }}>
        <BackButton onPress={() => navigation.navigate("PaywallReason4")} />
...
PaywallReason5Screen.propTypes = {
  navigation: PropTypes.object.isRequired,
  route: PropTypes.object,
};

export default PaywallReason5Screen;
