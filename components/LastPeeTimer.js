...
export function LastPeeTimer({ lastPeeTime }) {
  if (!lastPeeTime) {
    return (
      <View style={styles.container}>
        <Text style={styles.text}>{t.screens.home.timers.lastPee} : {t.screens.home.timers.lastPeeNoRecord} 💧</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.text}>{t.screens.home.timers.lastPee} : {lastPeeTime} 💧</Text>
    </View>
  );
}
